...
export const UseCaseModels: {[key in UseCase]: UseCaseModel} = {
    ...
    [UseCase.BotChat]: {title: "Mehrsprachiger Chatbot", description: `Frage mich etwas auf Englisch, Französisch, Italienisch oder Spanisch und lass dir meine Antwort auf Schweizerdeutsch vorlesen.​`},
